...
class SlaveImage(PersistentImage):
    """ SlaveImage can be linked from image metadata.
        It's created after base image and is suitable as a gen. purp. storage.
    """
    ...
    def __init__(self, image_id=None, name=None):
        ...
        @param template TODO
        """
        super(SlaveImage, self).__init__(image_id)
        self.template = None
        self.name = name
